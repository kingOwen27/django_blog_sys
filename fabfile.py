...
env.PROJECT_NAME = 'typeidea_testing'
env.SETTINGS_BASE = 'typeidea/typeidea/settings/base.py'
env.DEPLOY_PATH = '/Users/wyh/Desktop/venvs/typeidea-env'
env.VENV_ACTIVATE = os.path.join(env.DEPLOY_PATH, 'bin', 'activate')
env.PYPI_HOST = 'https://www.pypi.org'
env.PYPI_INDEX = 'https://www.pypi.org/simple'
env.PROCESS_COUNT = 2
env.PORT_PREFIX = 909
